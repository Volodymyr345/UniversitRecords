...
class University {
    ...
    public:
        ...
        bool add_professor(int age, const std::string &professorName, const std::string &subjectName);
        
        bool add_student(int age, const std::string&studentName, const std::string& course,const std::string &professorName);
